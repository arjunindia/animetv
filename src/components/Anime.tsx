...
const AnimeComponent = ({
  ...
  return (
    <Link
      ref={ref}
      className={`relative xl:w-1/6 md:w-1/4 w-1/2 m-3 h-auto focus:scale-105 ${focused ? "scale-105 outline outline-primary" : ""} shadow-lg ring-1 ring-black/5 rounded overflow-clip`}
      to={`/${result.id}`}
    >
